...
- Easy to [force renewal](./docs/advanced_usage.md#manualforce-renewal) of certificates if necessary.
- You can tune your own [renewal interval](./docs/good_to_know.md#renewal-check-interval).
